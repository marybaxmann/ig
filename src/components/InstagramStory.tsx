...
const Icons = {
  ...
  Send: () => <svg aria-label="Enviar" color="white" fill="white" height="28" viewBox="0 0 24 24" width="28"><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="7.488" x2="15.515" y1="12.208" y2="7.641"></line><path d="M2 12.023s1.505-4.867 7.856-6.312c1.801-.374 3.416 0 4.71.896.863.614 1.338 1.416 1.338 2.022 0 .608-.475 1.408-1.338 2.022-1.294.896-2.909 1.27-4.71.896C3.505 16.89 2 12.023 2 12.023z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
};
